...
//
//public class SlapScannerController_240122 implements Initializable {
...
//
//    public SlapScannerController_240122() {
...
//                System.out.println("No Fingerprint to scan, proceed to IRIS ");
//                statusField.setText("No Fingerprint to scan, proceed to IRIS ");
//            } else if (fingerPrintSet.size() < totalfingers) {
//                statusField.setText("Fingers Count Mismatching, Please Capture Again");
...
//                    captureModesCompleted.add(1);
//                    if (captureModesCompleted.size() == 3) {
//                        System.out.println("first bloack");
//                        showIrisBtn.setDisable(false);
//
//                    }
//                }
...
//                        statusField.setText("Place your " + thumbFingersToScan(arcDetails.getFingers()) + " thumb fingers on the sensor ");
//                    }
//                });
//
//                res = RealScan_JNI.RS_TakeImageData(deviceHandle, 20000, imageInfo);
...
//                System.out.println("Thumbs capture Not required, enabling iris capture");
