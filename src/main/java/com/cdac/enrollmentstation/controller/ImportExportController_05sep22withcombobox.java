 ...
 * @author root
 */
public class ImportExportController_05sep22withcombobox implements Initializable {
    /**
    ...
    public ImportExportController_05sep22withcombobox() {
...
//            ImportExportController ip = new ImportExportController();
    ...
    Runnable fetchUnit = new Runnable() {
        ...
        public void run() {
            ...
            String json = "";
            try {
                comboUnitId.getEditor().clear();
                //For clearing Unit Combobox
                ObservableList<String> units_clear = FXCollections.observableArrayList("");
                comboUnitId.setItems(units_clear);
                ...
                if (!connectionStatus.contentEquals("connected")) {
                    ...
                    try {
                        ...
                        try {
                           ...
                           */
                            ...
                            comboUnitId.valueProperty().addListener((obs, oldval, newval) -> {
                                ...
                                {
                                    System.out.println("Selected unit@fetch: " + newval);
                                }
                                responseStatus("");
                            });
                        ...
                        Logger.getLogger(ImportExportController_05sep22withcombobox.class.getName()).log(Level.SEVERE, null, ex);
                        response = "Unit List is not Available in the Server";
                        responseStatus(response);
                        return;
                        //return response;
        ...
        public void run() {
            ...
            try {
                ...
                for (Units result : unit) {
                    if (result.getCaption().equals(selectedUnit.trim())) {
