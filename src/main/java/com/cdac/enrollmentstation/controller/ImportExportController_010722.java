 ...
 * @author root
 */
public class ImportExportController_010722 {
    /**
    ...
    public String fetchUnit() {
        ...
        try {
            ...
            if (!connectionStatus.contentEquals("connected")) {
                ...
                response = "System is not connected to network. Connect and Try Again.";
                //messageStatus(response);
                return response;
            } else {
                try {
                    ...
                    Logger.getLogger(ImportExportController_010722.class.getName()).log(Level.SEVERE, null, ex);
                    response = "Unit Id List is not Available in the Server";
                    messageStatus(response);
                    //return response;
                }
    ...
    public String importjsonFile() {
        ...
        try {
            ...
            if (unit == null) {
                response = "Kindly Fetch and select the Values from UnitId";
                //messageStatus(response);
                return response;
            }
        ...
        try {
            ...
            //Production
            FileWriter file = new FileWriter(importjson + unitid + ".json");
            //Development
        ...
        if (directoryListing.length != 0) {
            ...
            for (File child : directoryListing) {
                ...
                try {
                    ...
                    } else if (enrollmentResponse.getErrorCode().equals("-4001")) {
                        response = child.getName() + " - " + enrollmentResponse.getDesc();
                        messageStatus(response);
                        child.delete();
                        aesDecryptFile.delFile(export + "/dec/" + child.getName());
    ...
    private String MergeJson() {
        ...
        try {
            ...
            if (jsonFile.exists()) {
                ...
                arcDetailsList1.getArcDetails().addAll(arcDetailsList1.getArcDetails());
