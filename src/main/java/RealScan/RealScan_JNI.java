...
//        public RSLFDInfo2[] sLFDInfo;
    ...
    native static int RS_GetDeviceHandle( int deviceIndex, int[] deviceHandle ); // return deviceHandle
    ...
    native static int RS_RegisterAdvCaptureDataCallback( int deviceHandle, Object provider, String method );
    ...
    native static int RS_SetParamInt( int deviceHandle, int type, int variable );
    native static int RS_GetParamInt( int deviceHandle, int type );
    ...
    native static int RS_GetKeyStatus( int deviceHandle, int[] keyCode ); // return keyMask
//  REALSCANSDK_API int __stdcall RS_RegisterKeypadCallback( int deviceHandle, RSKeypadCallback callback ); // Using JNI DLL
    ...
    native static int RS_RegisterKeypadCallbackEx( int deviceHandle, Object provider, String method );
    ...
    native static String RS_GetErrString( int errorCode ); 
	...
	native static int RS_GetTemplate( int templateType, byte[] imageData, int imageWidth, int imageHeight, byte[] pTemplate, int[] templateLength); // return Result, TemplateSize
    native static int RS_EncodeWSQ( byte[] rawdata, int width, int height, float ratio, byte[] wsqBuffer, int[] jpegBufferLen);
    native static int RS_DecodeWSQ( byte[] wsqData, int wsqLength, RSImageInfo rawImageInfo );
	native static int RS_EncodeJpeg2000( byte[] imageData, int imageWidth, int imageHeight, float bitrate, byte[] jpegBuffer, int[] jpegBufferLen); 
	native static byte[] RS_GenerateIso19794( int deviceType, RSImageInfo imageInfo, int imageBufferLength, int fingerPosition, int nCompressionMode);
	native static byte[] RS_MakeISOImageBuffer(
		int deviceType, 
