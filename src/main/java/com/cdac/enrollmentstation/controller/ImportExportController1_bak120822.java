 ...
 * @author root
 */
public class ImportExportController1_bak120822 implements Initializable {
    /**
                ...
                try {
                    ...
                    try {
                        ...
                        comboUnitId.valueProperty().addListener((obs, oldval, newval) -> {
                            if (newval != null)
                                System.out.println("Selected unit1: " + newval.getCaption()
                                        + ". ID: " + newval.getValue());
                        });
                    ...
                    Logger.getLogger(ImportExportController1_bak120822.class.getName()).log(Level.SEVERE, null, ex);
                    response = "Unit List is not Available in the Server";
                    messageStatus(response);
                    //return response;
                }
    ...
    public String importjsonFile() {
        ...
        try {
            ...
            System.out.println("Unit1:" + unit.getCaption() + " " + comboUnitId.getSelectionModel().getSelectedItem().getCaption());
            System.out.println("Unit1:" + unit.getCaption() + " " + comboUnitId.getSelectionModel().getSelectedItem().getValue());
