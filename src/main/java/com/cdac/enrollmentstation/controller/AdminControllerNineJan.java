 ...
 * @author root
 */
public class AdminControllerNineJan implements Initializable {
    ...
    public void serverconfig() {
        try {
            ...
            Logger.getLogger(AdminControllerNineJan.class.getName()).log(Level.SEVERE, null, ex);
